...
(function () {
  ...
  var css = ''
    ...
    + '.og-book{margin:12px auto 0;max-width:400px;overflow:hidden;border-radius:12px;border:1px solid rgba(0,213,255,.3);background:#fff}'
    + '.og-book iframe{width:100%;height:600px;border:0;display:block;background:#fff}'
    + '#og-panel.og-wide .og-book{max-width:440px}'
