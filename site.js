...
(function () {
  ...
  var GUIDES_V = 9; // ← bump whenever js/guides.js changes (immutable cache)
  ...
  var css = ''
    ...
    + '.ao-build{display:flex;align-items:center;gap:12px;margin-top:10px;padding:12px 14px;border-radius:12px;text-decoration:none;background:linear-gradient(135deg,rgba(30,144,255,.14),rgba(0,213,255,.07));border:1px solid rgba(0,213,255,.32);transition:transform .15s,box-shadow .15s,border-color .15s}'
    + '.ao-build:hover{transform:translateY(-1px);box-shadow:0 10px 26px rgba(0,213,255,.2);border-color:#00D5FF}'
    + '.ao-build-icon{font-size:18px;flex-shrink:0}'
    + '.ao-build-txt{flex:1;display:flex;flex-direction:column;line-height:1.25}'
    + '.ao-build-txt b{color:#fff;font-size:13.5px;font-weight:600;letter-spacing:-.005em}'
    + '.ao-build-txt small{color:rgba(247,250,255,.6);font-size:11px;margin-top:2px}'
    + '.ao-build-arr{color:#00D5FF;font-family:"JetBrains Mono",monospace;font-size:16px;font-weight:700;flex-shrink:0}'
